...
export default function BriefPage() {
  ...
  return <div className="screen review-screen"><Header title="Edit details" back={() => router.push("/ask")} action={<span className="draft-badge">AI DRAFT</span>} />
    ...
    <section className="preferences"><h2 className="section-label">PREFERENCES</h2><small>Trail matches picks to these. Each one filters something — nothing here is decoration.</small>
