...
export default function GiftsLens() {
  ...
  return <>
    <div className="approved-banner"><i><IconCheck /></i><span><small>ROUTE READY</small><b>{stops.length} stop{stops.length === 1 ? "" : "s"} · {price(wallet.plannedCents, trip.currency)} planned</b></span></div>
