...
export default function MemoryPage() {
  ...
  return <div className="screen profile-screen"><Header title="Memory & privacy" back={() => router.push("/trips")} />
    ...
    {memoryEnabled && <section className="ai-memory-card"><header><i><IconSpark /></i><span><small>PATTERNS IN USE</small><b>What I know about you</b></span><em>{trips.length} {trips.length === 1 ? "TRIP" : "TRIPS"}</em></header><div><span>Local over generic</span><span>Useful over decorative</span><span>Hands-free when possible</span></div><p>Trail uses approved patterns to rank gifts and handling. You still control every route and transfer.</p></section>}
