...
export type StoreRow = { id: string; name: string; address: string; area: string; dropoff_cutoff: string | null; lat: number | null; lng: number | null; accepted_handling?: Handling[] | null; max_weight_grams?: number | null; timezone?: string | null; dropoff_opens?: string | null; partner_note?: string | null };
