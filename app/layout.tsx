...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "TRAIL V3 — Your trip-aware gift planner",
    ...
    openGraph: {
      title: "TRAIL V3 — Your trip-aware gift plan",
    ...
    twitter: { card: "summary_large_image", title: "TRAIL V3 — Your trip-aware gift plan", description: "Talk about the gift, review the AI draft, customize every detail, then approve and shop.", images: [socialImage] },
  };
}
