...
export default function TrailDashboard() {
  ...
  return <div className="screen home-screen"><Header action={<Avatar city={trip.city} />} />
    <TripContextBar trip={{ id: trip.id, city: trip.city, country: trip.country }} day={app.hydrated ? dayOfTrip(trip.startDate, trip.endDate, trip.timezone) : null} onOpenSwitcher={switcher.open} switcherOpen={switcher.isOpen} />
    {switcher.sheet}
